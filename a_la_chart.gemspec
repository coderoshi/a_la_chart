...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "MIT-LICENSE", "Manifest.txt", "README.rdoc", "Rakefile", "configs/fusion/3.1/angular.xml.builder", "configs/fusion/3.1/bar.xml.builder", "configs/fusion/3.1/bullet.xml.builder", "configs/fusion/3.1/column.xml.builder", "configs/fusion/3.1/funnel.xml.builder", "configs/fusion/3.1/remote.html.erb", "configs/fusion/3.1/inline.html.erb", "configs/fusion/3.1/line.xml.builder", "configs/fusion/3.1/pie.xml.builder", "configs/fusion/3.1/pyramid.xml.builder", "configs/fusion/3.1/spark_column.xml.builder", "configs/fusion/3.1/spark_line.xml.builder", "configs/fusion/3.1/spark_win_loss.xml.builder", "configs/fusion/3.1/stacked_column.xml.builder", "configs/fusion/config.yml", "configs/google/1.0/pie.html.erb", "configs/google/config.yml", "configs/raphael/1.2/dot.html.erb", "configs/raphael/1.2/impact.js.erb", "configs/raphael/1.2/inline.html.erb", "configs/raphael/config.yml", "init.rb", "lib/a_la_chart.rb", "lib/a_la_chart/a_la_chart_helper.rb", "lib/a_la_chart/a_la_chart.rb", "script/console", "script/destroy", "script/generate", "test/a_la_chart_test.rb", "test/test_a_la_chart.rb", "test/test_helper.rb"]
